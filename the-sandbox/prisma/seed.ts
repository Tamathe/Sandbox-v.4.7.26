...
The AI plays in-house counsel for the acquiring company. Push back, make offers, find a deal — or walk away if the terms don't work.`,
    ...
    where: { id: 'tool-organic-chemistry' },
    update: {},
    create: {
      id: 'tool-organic-chemistry',
      name: 'Organic Chemistry Reaction Predictor',
      shortDescription: 'Describe reactants and conditions — get product predictions, mechanisms, and quizzes.',
      fullDescription: `## Organic Chemistry Reaction Predictor

An AI-powered tool for learning and practicing organic chemistry reaction mechanisms.

### How It Works
1. Describe your starting materials (reactants) and reaction conditions
2. The AI predicts the products and explains the reaction mechanism step-by-step
3. Test your understanding with follow-up quiz questions
...
- Aromatic chemistry
- Named reactions (Diels-Alder, Grignard, etc.)

### Ideal Use
Use this alongside your textbook to check your work, understand mechanisms you're struggling with, or drill for exams.`,
      category: 'STEM',
      difficultyLevel: 'Intermediate',
      estimatedMinutes: 20,
      toolType: ToolType.EXTERNAL,
      externalUrl: 'https://example.com/orgo-predictor',
      learningObjectives: [
        'Predict products of common organic reactions',
        'Understand reaction mechanisms at the electron-pushing level',
        'Apply reaction knowledge to novel substrate combinations',
      ],
      intendedAudience: 'Undergraduate students in Organic Chemistry I or II',
      published: true,
      featured: false,
      approvalStatus: 'APPROVED',
      ...
      customMetrics: {
        create: [
          { name: 'reactions_attempted', type: 'COUNTER', description: 'Number of reactions the student attempted' },
          { name: 'quiz_score', type: 'RATING', description: 'Average quiz score' },
        ],
      },
    },
  })
...
Start with a claim or a question. The more specific, the better. Don't worry about being "wrong" — the goal is to think more clearly, not to win.`,
  ...
  const tool6 = await prisma.tool.upsert({
    where: { id: 'tool-business-case' },
    update: {},
    create: {
      id: 'tool-business-case',
      name: 'Business Case Analyzer',
      shortDescription: 'Upload a business case and get AI-powered SWOT analysis and discussion questions.',
      fullDescription: `## Business Case Analyzer

Accelerate your business case preparation with AI-powered analysis.

### What It Does
Upload or paste a business case study and receive:
- **SWOT Analysis**: Strengths, Weaknesses, Opportunities, Threats
- **Porter's Five Forces**: Competitive landscape assessment
- **Key Discussion Questions**: For class participation preparation
- **Framework Suggestions**: Which analytical frameworks apply best
- **Executive Summary**: Quick synopsis of the key issues

### Great For
- Preparing for class discussion
- Building your case analysis skills
- Time-constrained exam prep
- Understanding which frameworks apply to different business contexts

### How To Use
The tool accepts text input — paste the case text or a detailed description. For best results, include the company background, the central problem, and key data points.`,
      category: 'Business',
      difficultyLevel: 'Advanced',
      estimatedMinutes: 45,
      toolType: ToolType.EXTERNAL,
      externalUrl: 'https://example.com/business-case-analyzer',
      learningObjectives: [
        'Apply SWOT and Porter\'s Five Forces frameworks to real business cases',
        'Identify the core problem and stakeholder interests in business scenarios',
        'Develop structured case analysis skills for presentations and exams',
      ],
      intendedAudience: 'MBA students and undergraduate business students in strategy courses',
      published: true,
      featured: false,
      approvalStatus: 'APPROVED',
      ...
      customMetrics: {
        create: [
          { name: 'cases_analyzed', type: 'COUNTER', description: 'Number of cases analyzed' },
          { name: 'time_on_task_seconds', type: 'DURATION', description: 'Time spent analyzing each case' },
        ],
      },
    },
  })
...
- For any action requiring account access, redirect to: myUK portal, OSFAS (857-257-3172), or 127 Funkhouser Building
