  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12">
      <div className="w-full max-w-xl rounded-3xl border border-red-200 bg-white p-8 shadow-sm">
        <div className="mb-4 inline-flex size-14 items-center justify-center rounded-2xl bg-red-100 text-red-700">
          <ShieldAlert className="size-7" />
        </div>
        <h1 className="text-2xl font-extrabold text-slate-900">Your account is under review</h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          Access is currently limited for this account while an administrator
