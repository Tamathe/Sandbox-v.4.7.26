...
export default function MindfulnessCoachPage() {
  ...
  } = useWellnessHubTool('mindfulness')
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-extrabold text-gray-900">Mindfulness Coach</h1>
              <p className="text-sm text-gray-500">Sandy helps you track mood and energy with a quick daily check-in</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className={`lg:col-span-7 bg-white border-2 border-gray-200 rounded-2xl p-6 overflow-y-auto ${mobileTab !== 'check-in' ? 'hidden lg:block' : ''}`}>
            {output ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center">
                ...
                <p className="text-sm text-gray-400">Answer Sandy&apos;s questions for your daily check-in</p>
              </div>
            )}
          </div>
