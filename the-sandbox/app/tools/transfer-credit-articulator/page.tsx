...
const ARTICULATION_MESSAGES = [
  'Reviewing the course description',
  'Comparing against UK equivalents',
...
export default function TransferCreditArticulatorPage() {
  ...
  const articulationMessage = useRotatingMessage(ARTICULATION_MESSAGES, 2000, submitting)
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)]">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-6">
              <h2 className="text-xl font-extrabold text-slate-900">Evaluate a transfer request</h2>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              >
                ...
                {submitting ? articulationMessage : 'Evaluate Transfer Credit'}
              </button>
            </form>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-extrabold text-slate-900">Evaluation Result</h2>
            ...
            {result ? (
              <div className="space-y-5">
                ...
                {canReview ? (
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    >
                      {decisionLoading === 'APPROVED' ? <Loader2 className="size-4 animate-spin" /> : <CheckCircle2 className="size-4" />}
                      Approve
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      {decisionLoading === 'DENIED' ? <Loader2 className="size-4 animate-spin" /> : <XCircle className="size-4" />}
                      Deny
                    </button>
                  </div>
                ) : null}
              ...
              <div className="flex min-h-96 flex-col items-center justify-center rounded-3xl border border-dashed border-slate-200 bg-slate-50 px-6 text-center">
                <Clock3 className="size-12 text-slate-300" />
                <h3 className="mt-4 text-lg font-extrabold text-slate-900">No evaluation yet</h3>
        ...
        <div className="mt-8 rounded-3xl border border-slate-200 bg-white shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 px-6 py-5">
            <div>
              <h2 className="text-xl font-extrabold text-slate-900">Recent evaluations</h2>
              <p className="mt-1 text-sm text-slate-500">
                {canReview
