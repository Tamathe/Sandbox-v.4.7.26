...
import { getRefinePrompt, type InstitutionalResumeRefineRequest } from '../../../../lib/institutional-resume-service'
...
export const POST = withErrorHandling(async (req: NextRequest) => {
  ...
  const body = parsed.data as InstitutionalResumeRefineRequest
